...
echo '<div class="patternrecord" style="display:none">'.$_GET["pattern"].'</div>';
...
echo '<div class="input-group col-lg-4">
        ...
        <input class="filter form-control" id="prependedInput" type="text" style="" placeholder="eg. Number, Status" value="'.$_GET["pattern"].'">
	...
	/*	    var rex = new RegExp($(\'input.filter\').val(), \'i\');
		...
		searchHide();
         ...
         $(\'#searchbtn\').click(function() {
			...
			$(".patternrecord").text(pattern);
			$(".pooltablediv").load("searchcustomertable.php", { \'sel\': pattern}, function() {
...
/*                        var pattern = $(".recordsel").text();;
			$(".pooltablediv").load("searchcustomertable.php", { \'sel\': \'go\'}, function() {
                                var selText = $(".recordsel").attr("id");;
                                $(".pooltr").hide();
                                $("."+selText).show();
                                searchHide();
                        ...
                        $(".actlistdiv").load("searchcustomercbtable.php", { \'sel\': \'go\'}, function() {
                                searchHide();
                        });
...
/*                $(".nav li a").each(function(){
		...
		var pat = $(".patternrecord").text();
		$(".pooltablediv").load("searchcustomertable.php", { \'sel\': pat}, function() {
			var selText = $(".recordsel").attr("id");;
			$(".pooltr").hide();
			$("."+selText).show();
		...
		$(".actlistdiv").load("searchcustomercbtable.php", { \'sel\': pat}, function() {
			searchHide();
		});
