...
if(login_check() == true) {
   global $n;
        ...
        $stmt = new DB_Sql;
        $stmt->query("SELECT id, type, username, agentID, mainAgent, company, shipable, billable from agents where id = '$user_id'");
        $stmt->next_record();
...
if($magent=="958348" || $agent_id=="958348" || $magent=="623411" || $agent_id=="623411"){
echo     '       <input type="hidden" value="Staff" name="SUBMITTYPE">';
}else{
echo     '       <input type="hidden" value="Agent" name="SUBMITTYPE">';
}
echo     '       <input type="hidden" value="N" name="BILLTOAGENT">';
echo     '       <input type="hidden" value="'.$shipable.'" name="SHIPFROMAGENT">';
echo'            <input style="display:none" value="" id="extra" name="extra">
...
<input type="checkbox" onchange="CalculateTotal();" value="1" id="pkg1009" name="pkg1009">The Movie Network Package $15.99<br>
...
<input type="checkbox" onchange="CalculateTotal();" value="1" id="pkg1021" name="pkg1021">The Movie Network Package $15.99<br>
...
print        '		</select>
			<!--<font size="-2" color="grey"><span id="isp" name="isp"><br>You can order required Internet Service through:<br><a target="_blank" href="http://www.distributel.ca">Distributel</a><br><a target="_blank" href="http://www.acanac.com">Acanac Inc.</a><br><a target="_blank" href="http://www.xinflix.com">Xinflix Media Inc.</a><br><a target="_blank" href="http://www.mustangtechno.com/">Mustang Technologies Inc.</a><br></span><br>
</font>--></td>
...
<script type="text/javascript">
	...
	<tr>
              ...
              <tr>
                ...
                <td align="left" bgcolor="#ffffff"><select  name = "YEAR01" size="1" class="span2">
                  <option selected="selected" value = "---select-one---">---select-one--- </option>
                  ...
                  &nbsp;/&nbsp;
                  <select  name = "YEAR" size="1" class="span2">
                    <option selected="selected" value = "---select-one---">---select-one--- </option>';
...
print '</select>
<br><table width=95%><tr><td style=\'padding-top:5px\'>Why do we ask for your date of birth? Zazeen believes in giving back to our customers for their loyalty. By entering your birth date you automatically quality for service discounts or gifts on your anniversary.<br><br></td></tr></table></td>
                </tr>
...
echo	'	if (tc[1][0]!=incomplete && tc[1][1]!=incomplete)
		{
