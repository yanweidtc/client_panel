...
if(login_check() == true) {
   ...
   echo "<pre>Select Province</pre>";

   echo '<label class="radio">
	<input type="radio" name="optionsRadios" id="optionsRadios1" value="ON" checked>
	Ontario
	</label>
	<label class="radio">
	<input type="radio" name="optionsRadios" id="optionsRadios2" value="QB">
	Quebec
	</label>';

   echo        '          <a class="btn btn-primary" href="form.php">Next</a>'.$n;
