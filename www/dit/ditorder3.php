...
<!--          <form  action = "https://www.zazeen.com/agent/showpost.php" method = "post" onSubmit="return form1_onsubmit();">-->
          <form  action = "https://www.zazeen.com/agent/dash.php" method = "post" onSubmit="return form1_onsubmit();">
...
-->
              ...
              <tr style=''>
                ...
                <td align="left" bgcolor="#ffffff"><select  style="background-color:silver" name="ppromo" size="1" onfocusout='CalculateTotal();' onchange='CalculateTotal();'>
