...
/**********************************************Chris 2014-05-30 Adapters(not done)****************************/
        ...
        if (s1=="")
        {
                ...
                if (taxpercent!=-1)
                {
                        tc[3][3]=roundit((1.0*tc[1][3]+1.0*tc[2][3]+1.0*tc[5][3]+1.0*tc[6][3]+1.0*tc[7][3]+1.0*tc[8][3]+1.0*tc[9][3])*taxpercent/100.0,2);
                        tc[4][3]=roundit(1.0*tc[1][3]+1.0*tc[2][3]+1.0*tc[5][3]+1.0*tc[3][3]+1.0*tc[6][3]+1.0*tc[7][3]+1.0*tc[8][3]+1.0*tc[9][3],2);
                }
        }
        else
        {
...
<!--          <form  action = "https://www.zazeen.com/agent/showpost.php" method = "post" onSubmit="return form1_onsubmit();">-->
          <form  action = "https://www.zazeen.com/cgi-bin/orders.cgi/Order_iptv.html" method = "post" onSubmit="return form1_onsubmit();">
        ...
        function changenum(id,id1)
        {
              ...
              <tr>
                ...
                <table>
                        ...
                        <tr>
                                <td>Entone <span style='float:right'>($200.00 ea.)&nbsp;&nbsp;</span></td>
                                <td>
                        ...
                        <tr>
                                <td>Wnc: <span style='float:right'>($150.00 ea.)&nbsp;&nbsp;</span></td>
                                <td>
                        ...
                        <tr style='display:none'>
                                <td>Amino: <span style='float:right'>($150.00 ea.)&nbsp;&nbsp;</span></td>
                                <td>
